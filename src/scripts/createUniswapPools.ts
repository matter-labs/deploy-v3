...
async function main(): Promise<void> {
  console.log('Starting zkSync script');
  ...
  const npmca: string = '0x4cE585EA0b2112fD7692BB4f4725365A6F5118F5';
  const uniswapFactoryAddress: string = '0xA47a949de6D367FBA4D5355EF0ddFDe952d42C7E';
  ...
  console.log('zkSync script completed');
}
